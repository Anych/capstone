...
//        Setting siteName = new Setting("SITE_NAME", "Mila&Iris", SettingCategory.GENERAL);
        Setting siteLogo = new Setting("SITE_LOGO", "logo.png", SettingCategory.GENERAL);
        Setting copyright = new Setting("COPYRIGHT", "Copyright (C) 2022 Mila&Iris", SettingCategory.GENERAL);
