...
import kz.milairis.admin.security.userdetail.MilaIrisUserDetailsService;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public UserDetailsService userDetailsService() {
        return new MilaIrisUserDetailsService();
    }
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests().antMatchers("/users/**", "/settings/**", "/countries/**", "/states/**")
                .hasAuthority("Admin").antMatchers("/categories/**", "/brands/**")
